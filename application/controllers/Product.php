         ...
         for($i=2;$i<=$totalrows;$i++)
          {
				...
				$type           = $objWorksheet->getCellByColumnAndRow(2,$i)->getValue(); //Excel Column 3
				...
				$designed_for   = $objWorksheet->getCellByColumnAndRow(19,$i)->getValue(); //Excel Column 4
				$suitable_for   = $objWorksheet->getCellByColumnAndRow(20,$i)->getValue(); //Excel Column 4
				$height         = $objWorksheet->getCellByColumnAndRow(21,$i)->getValue(); //Excel Column 4
				$width          = $objWorksheet->getCellByColumnAndRow(22,$i)->getValue(); //Excel Column 4
				$length         = $objWorksheet->getCellByColumnAndRow(23,$i)->getValue(); //Excel Column 4
				$height_unit    = $objWorksheet->getCellByColumnAndRow(24,$i)->getValue(); //Excel Column 4
				$width_unit     = $objWorksheet->getCellByColumnAndRow(25,$i)->getValue(); //Excel Column 4
				$length_unit    = $objWorksheet->getCellByColumnAndRow(26,$i)->getValue(); //Excel Column 4
				$weight         = $objWorksheet->getCellByColumnAndRow(27,$i)->getValue(); //Excel Column 4
				$weight_unit    = $objWorksheet->getCellByColumnAndRow(28,$i)->getValue(); //Excel Column 4
				$model_name     = $objWorksheet->getCellByColumnAndRow(29,$i)->getValue(); //Excel Column 4
				$model_num      = $objWorksheet->getCellByColumnAndRow(30,$i)->getValue(); //Excel Column 4
				$features       = $objWorksheet->getCellByColumnAndRow(31,$i)->getValue(); //Excel Column 4
				$sales_package  = $objWorksheet->getCellByColumnAndRow(32,$i)->getValue(); //Excel Column 4
				$key_feature    = $objWorksheet->getCellByColumnAndRow(33,$i)->getValue(); //Excel Column 4
				$other_feature  = $objWorksheet->getCellByColumnAndRow(34,$i)->getValue(); //Excel Column 4
				...
				// $size                  = $objWorksheet->getCellByColumnAndRow(39,$i)->getValue(); //Excel Column 4
					...
					// 'warrenty'              =>htmlentities($warrenty),
					// 'warrenty_summary'      =>htmlentities($warrenty_summary),
					// 'warrenty_service_type' =>htmlentities($warrenty_survice_type),
					// 'covered_in_warrenty'   =>htmlentities($covered_in_warrenty), 
					// 'no_in_warrenty'        =>htmlentities($not_in_warrenty),
					// 'is_fragile'            =>htmlentities($is_fragile),
				...
				$data_product = array(
					...
					'compare_price'         =>htmlentities($old_price),
					'quantity'              =>htmlentities($quantity),
					'thumbnail'             =>htmlentities($thumbnail1), 
					'sku'                   =>htmlentities($sku),
					'category_id'           =>htmlentities($category_id), 
					'description'           =>htmlentities($description), 
					'shipping'              =>htmlentities($shipping_cost), 
					'status'                =>1, 
					'thumbnail2'            =>htmlentities($thumbnail2), 
					'thumbnail3'            =>htmlentities($thumbnail3),
					'thumbnail4'            =>htmlentities($thumbnail4),
					'subtitle'              =>htmlentities($subtitle),
					'brand'                 =>htmlentities($brand),
					'color'                 =>htmlentities($color_name), 
					'color_code'            =>htmlentities($color_code), 
					'tags'                  =>htmlentities($tags),
					'features'              =>htmlentities($features),
					'sales_package'         =>htmlentities($sales_package),
					'key_feature'           =>htmlentities($key_feature),
					'other_feature'         =>htmlentities($other_feature),
					'model_name'            =>htmlentities($model_name),
					'model_number'          =>htmlentities($model_num),
					'designed_for'          =>htmlentities($designed_for),
					'suitable_for'          =>htmlentities($suitable_for),
					'width'                 =>htmlentities($width),
					'height'                =>htmlentities($height),
					'length'                =>htmlentities($length),
					'length_unit'           =>htmlentities($length_unit),
					'width_unit'            =>htmlentities($width_unit),
					'height_unit'           =>htmlentities($height_unit),
					'weight_unit'           =>htmlentities($weight_unit),
					'upload_type'           =>'excel',
